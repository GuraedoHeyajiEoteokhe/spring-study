...
- 종류 : MySQL, 오라클 등
- 특징에 따른 분류 : 관계형, 객체-관계형, 도튜먼트형, 비관계형 등
...
> #### 🍎 2주차 스터디
> 4장<br>
> 테스트 코드의 구조와 필요성을 다시 확인할 수 있었고, 
> 수업 시간에 활용한 given-when-then 방식이 실제로 어떻게 적용되는지 이해할 수 있었음<br>
> 5장<br>
> 기본적인 SQL 개념을 다시 정리한 뒤 
> ORM·JPA·영속성 컨텍스트를 통해 SQL 작성 없이도 객체 중심으로 DB를 다룰 수 있다는 점을 새롭게 이해하게 된 시간이었음

---
## 리뷰어: 이형욱
### 04장 테스트

테스트에 대한 개념 정리와 용어 정리가 잘 되어 있어서 잘 확인했습니다. 그 외에 대한 어노테이션, given, when, then 도 잘 정리해주셔서 코멘트 달 내용이 없습니다.

### 05장 ORM

각 주제마다 ? 붙이고 한 줄 설명해 주시는 부분이 이해잘 되고 설명이 잘 되어 있던 것 같습니다. 

5.3 의 영속성 콘텍스트에 transient 라는 단어가 없어서(설명은 있습니다-비영속) 개념 정리 상 추가하셔도 좋을 것 같습니다.

> 오타들 적어놨습니다.
4.1 테스트코드 개념익히기에 given-when-then 부분
4.2 의 `@Display("1+2는3이다")` 테스트 코드 밑에 주석부분 첫 줄에 테스트 오타 있습니다.
5.1 첫째 문단에 특징에 따른 분류: 객체-관계형 오타 있습니다
>
